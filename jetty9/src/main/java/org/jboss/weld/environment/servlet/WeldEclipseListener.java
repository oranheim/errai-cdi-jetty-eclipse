...
import org.jboss.weld.environment.gwtdev.GwtDevHostedModeJettyPost72Container;
 ...
 * @author Ales Justin
 */
public class WeldEclipseListener extends ForwardingServletListener {
    ...
    protected Container findContainer(ContainerContext cc, StringBuilder dump) {
        ...
        if (container == null)
            container = checkContainers(cc, dump, Arrays.asList(
            		...
            		GwtDevHostedModeJettyPost72Container.INSTANCE,
