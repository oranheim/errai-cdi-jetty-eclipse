 ...
 *
 */
public class GwtDevHostedModeJettyPost72Container extends JettyPost72Container {
    public static Container INSTANCE = new GwtDevHostedModeJettyPost72Container();
